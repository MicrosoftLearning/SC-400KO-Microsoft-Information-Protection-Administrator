...
5. 신뢰할 수 없는 리포지토리 보안 대화 상자가 표시되면 Yes에 해당하는 **Y** 키를 누르고 Enter 키를 누릅니다.
...
3. **규정 준수 센터**의 왼쪽 탐색 창에서 **... 모두 표시**를 선택하고 **정보 보호**를 선택합니다.  

4. 정보 보호 페이지에서 **+ 레이블 만들기**를 선택합니다.

5. **새 민감도 레이블** 마법사가 시작됩니다. **이름 및 설명** 페이지의 **이름**, **관리자를 위한 설명** 및 **사용자를 위한 설명**에 다음 정보를 각각 입력합니다.

	- **이름**: 내부
	- **표시 이름**: 내부
	- **사용자를 위한 설명**: 내부용 민감도 레이블입니다.
	- **관리자를 위한 설명**: 내부용 민감도 레이블입니다.
...
13. **마침** 페이지에서 **레이블 만들기**를 선택합니다.

14. 레이블이 만들어지며, 만들기가 완료되면 다음 메시지가 표시됩니다. **레이블을 만들었습니다.**

15. **완료**를 선택합니다.

16. 정보 보호 페이지에서 새로 만든 **내부** 레이블을 강조 표시(선택하지는 않음)하고 **...** 를 선택합니다.

17. 드롭다운 메뉴에서 **+ 하위 레이블 추가**를 선택합니다.

18. **새 민감도 레이블** 마법사가 시작됩니다. **이름 및 설명** 페이지의 **이름**, **관리자를 위한 설명** 및 **사용자를 위한 설명**에 다음 정보를 각각 입력합니다.
...
20. **범위** 페이지에서 **파일 및 전자 메일** 옵션을 선택합니다.

21. **다음**을 선택합니다.

22. **파일 및 전자 메일** 페이지에서 **파일 및 전자 메일 암호화** 옵션을 선택합니다.
...
30. **자동 레이블 지정** 페이지에서 **다음**을 선택합니다.

31. **그룹 및 사이트** 페이지에서 **다음**을 선택합니다.

32. **Azure Purview 자산(미리 보기)** 페이지에서 **다음**을 선택합니다. 

33. **마침** 페이지에서 **레이블 만들기**를 선택합니다.
...
4. **정보 보호** 페이지에서 **레이블 게시**를 선택합니다.

5. 민감도 레이블 게시 마법사가 시작됩니다.

6. **게시할 레이블 선택** 페이지에서 **게시할 민감도 레이블 선택** 링크를 선택합니다.
...
10. **게시할 레이블 선택** 페이지에서 **다음**을 선택합니다.

11. **사용자 및 그룹에 게시** 페이지에서 **다음**을 선택합니다.

12. **정책 설정** 페이지에서 **다음**을 선택합니다.

13. **이름 및 설명** 페이지에서 다음 정보를 입력합니다.
...
15. **설정 검토** 페이지에서 **제출**을 선택합니다.

16. 정책이 만들어지며, 만들기가 완료되면 **새 정책을 만들었습니다.** 라는 메시지가 표시됩니다.
...
2. 그리고 **Microsoft Edge**에는 Office 365 규정 준수 센터 탭이 계속 열려 있어야 합니다. 주소 표시줄을 선택하고 **https://portal.office.com** 으로 이동합니다.
...
6. **새 민감도 레이블** 마법사가 시작됩니다. **이름 및 설명** 페이지에서 다음 정보를 입력합니다.
...
8. **범위** 페이지에서 **파일 및 전자 메일** 옵션을 선택합니다.

8. **다음**을 선택합니다.

9. **파일 및 전자 메일** 페이지에서 **다음**을 선택합니다.

10. **자동 레이블 지정** 페이지에서 **파일 및 전자 메일의 자동 레이블 지정**을 사용하도록 설정합니다.
...
19. **그룹 및 사이트** 페이지에서 **다음**을 선택합니다.

20. **Azure Purview 자산(미리 보기)** 페이지에서 **다음**을 선택합니다. 

21. **마침** 페이지에서 **레이블 만들기**를 선택합니다.
...
26. **게시할 레이블 선택** 페이지에서 **게시할 민감도 레이블 선택** 링크를 선택합니다.
...
30. **게시할 레이블 선택** 페이지에서 **다음**을 선택합니다.

31. **사용자 및 그룹에 게시** 페이지에서 **다음**을 선택합니다.

32. **정책 설정** 페이지에서 **다음**을 선택합니다.

33. **이름 및 설명** 페이지에서 다음 정보를 입력합니다.
...
35. **설정 검토** 페이지에서 **제출**을 선택합니다.

36. 정책이 만들어지며, 만들기가 완료되면 **새 정책을 만들었습니다.** 라는 메시지가 표시됩니다.
