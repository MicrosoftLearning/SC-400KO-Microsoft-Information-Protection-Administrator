...
3. **규정 준수 센터**의 왼쪽 탐색 창에서 **정보 보호**를 선택합니다.  
...
4. **정보 보호** 페이지의 **레이블** 페이지에서 **레이블 게시**를 선택합니다.
...
13. **정책 이름 지정** 페이지에서 다음 정보를 입력합니다.
...
2. **Microsoft Edge**에는 Office 365 규정 준수 센터 탭이 계속 열려 있어야 합니다. 주소 표시줄을 선택하고 **https://portal.office.com**으로 이동합니다.
...
3. **Microsoft 365 규정 준수** 센터의 왼쪽 탐색 창에서 **정보 보호**를 선택합니다.  
...
10. **파일 및 전자 메일에 자동 레이블 지정** 페이지에서 **파일 및 전자 메일의 자동 레이블 지정**을 사용하도록 설정합니다.
...
33. **정책 이름 지정** 페이지에서 다음 정보를 입력합니다.
