...
4. **메시지 데이터 분류** 메시지가 표시되면 **닫기**를 선택하고 위쪽 창에서 **중요한 정보 유형**을 선택합니다.  힌트: 규정 준수 센터에 **중요한 정보 유형**이 표시되지 않으면 이전 랩에서 규정 준수 관리자로 업데이트된 Joni의 권한이 아직 브라우저에서 업데이트되지 않은 것입니다.  로그아웃했다가 JoniS로 다시 로그인해야 할 수 있습니다.

5. **+ 중요한 정보 유형 만들기**를 선택하여 새 중요한 정보 유형 만들기 마법사를 엽니다.
...
12. ID 필드에 *직원 ID 키워드*를 입력하고 **대/소문자 구분 안 함** 아래의 텍스트 상자에 *직원*, *ID*를 입력한 다음 **완료**를 선택합니다.
...
51. **EDM 중요한 정보 유형 이름 지정 및 설명** 페이지에서 *Contoso 직원 EDM*을 입력합니다.
...
5. **중요한 정보 유형 이름 지정** 페이지의 **이름**에 *Contoso 병가 요청 가능 질환 목록*을 입력합니다.
...
14. **키워드 목록 추가** 페이지의 **ID** 필드에 *직원 결근*을 입력합니다. **대/소문자 구분 안 함** 상자에 *employee,absence,reason* 키워드를 입력한 다음 **완료**를 선택합니다.

15. **새 패턴** 페이지에서 구성을 검토하고 **만들기**를 선택합니다.

16. **이 중요한 정보 유형에 대한 패턴 정의**에서 **다음**을 선택합니다.

17. **규정 준수 정책에 표시할 권장 신뢰 수준 선택**에서 기본값을 사용하고 **다음**을 선택합니다. 

18. **설정 검토 후 완료** 페이지에서 설정을 검토하고 **만들기**를 선택합니다.  프로세스가 완료되면 **완료**를 선택합니다.

19. Microsoft 365 규정 준수 센터가 표시된 브라우저 창을 열어 둡니다.
