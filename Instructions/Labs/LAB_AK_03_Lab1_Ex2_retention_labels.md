...
8. **보존 설정** 페이지에서 **특정 기간 동안 항목 보존** 설정을 사용하도록 설정합니다.
...
11. 검토 후 완료 페이지에서 **레이블 만들기** 단추를 선택합니다.  **레이블만 저장**을 선택하고 **완료**을 선택합니다.

12. **정보 거버넌스** 페이지의 **레이블** 탭으로 돌아옵니다.  이후 연습에서 레이블을 게시하겠습니다.

13. **+ 레이블 만들기** 단추를 선택합니다.

14. 정책 이름 지정 페이지의 **이름**, **관리자를 위한 설명** 및 **사용자를 위한 설명**에 다음 정보를 각각 입력합니다.
	- **이름**: 신용 카드 영수증
...
18. **설정 검토** 페이지에서 **레이블 만들기** 단추를 선택합니다. **레이블만 저장**을 선택하고 **완료**을 선택합니다.

보존 기간이 7년인 VAT 환급 문서용 보존 레이블과 신용 카드 영수증용 보존 레이블을 만들었습니다.

### 작업 2 - 보존 레이블 게시

이 작업에서는 작업 1에서 만든 VAT 환급 문서 보존 레이블을 게시합니다. 그러면 경리부 사용자들이 Exchange 이메일 및 SharePoint 문서가 저장된 위치에서 해당 문서에 게시된 레이블을 적용할 수 있습니다.
...
13. **설정 검토** 페이지에서 **제출** 단추를 선택합니다.  정책이 게시되면 **완료**를 선택합니다.

VAT 환급 및 지원 문서용 보존 레이블을 게시했습니다.

### 작업 3 - 자동 적용 보존 레이블 게시

이 작업에서도 작업 1에 이어 신용 카드 영수증 보존 레이블을 자동 적용합니다. 
...
6. **레이블 자동 적용** 단추를 선택합니다.  그러면 콘텐츠에 자동으로 레이블 적용 마법사가 표시됩니다.
...
9. **레이블 지정할 정보** 페이지의 이 레이블에 적용할 콘텐츠의 유형 선택에서 다음 옵션을 선택합니다.
...
16. **위치** 페이지에서 **Exchange 이메일, OneDrive, SharePoint 사이트 및 Microsoft 365 그룹** 옵션을 사용하도록 설정하고 **다음**을 선택합니다.

17. **레이블** 페이지에서 **다음**을 선택합니다.

18. **마침** 페이지에서 **제출** 단추를 선택합니다.
...
이 작업에서는 Outlook 이메일에 보존 레이블을 할당합니다.
...
3.  **새 폴더**를 선택하고 다음 이름을 입력합니다. VAT 환급
...
Outlook 폴더에 보존 레이블을 적용했습니다. 이 하위 작업에서 선택한 설정에 따라 이 폴더 내의 모든 이메일에 기본 보존 레이블이 할당됩니다.
...
8. 강조 표시된 문서에서 **...** 단추를 선택합니다.

9. 메뉴 선택 항목에서 **세부 정보** 단추를 선택합니다.

10. 오른쪽에 측면 메뉴가 나타납니다.

11. **VAT 환급 및 지원 문서** 옵션이 사용 가능하면 **보존 레이블 적용**을 해당 옵션으로 설정합니다. 보존 레이블이 게시되려면 시간이 다소 걸릴 수도 있으므로 이 옵션을 즉시 사용하지는 못할 수도 있습니다. 이 옵션을 사용할 수 없어도 괜찮으므로 다음 작업을 계속 진행하세요.
...
3. Microsoft O365 방문 페이지에서 점 9개로 표시된 왼쪽 위의 앱 시작 관리자를 선택하고 하위 메뉴에서 **OneDrive**를 선택합니다.

4.  OneDrive 애플리케이션 내에서 **Contractor Legal Info.docx** 문서를 강조 표시합니다(선택은 하지 않음).

5. 강조 표시된 문서에서 **...** 단추를 선택합니다.
