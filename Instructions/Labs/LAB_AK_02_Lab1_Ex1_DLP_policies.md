...
17. **Microsoft 365 위치에서 액세스 제한 또는 콘텐츠 암호화** 앞에 있는 체크박스를 선택하고 **모든 사람 차단**을 선택합니다. **모든 사람, 콘텐츠 소유자, 마지막으로 수정한 사람 및 사이트 관리자만 계속 액세스할 수 있습니다.** 를 선택합니다.
...
23. **정책 테스트 또는 켜기** 페이지에서 **먼저 테스트**를 선택하고 **테스트 모드에 있을 때 정책 팁 표시**를 선택합니다.

24. **다음**을 선택하고 정책 구성을 검토합니다.

25. **제출**을 선택하여 정책을 만듭니다.

26. 정책이 만들어지면 **완료**를 선택합니다.
...
5. **정책 이름 지정y**페이지에서 *테넌트 전체 SharePoint 정책*을 입력하고 **다음**을 선택합니다.
